...
public class ModItems {
    ...
    public static final Item OAK_PICKAXE = register("oak_pickaxe", new OakPickaxe(ToolMaterials.WOOD, 1, -2.8F, new FabricItemSettings()));
    public static final Item OAK_SWORD = register("oak_sword", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new FabricItemSettings()));
    public static final Item OAK_HOE = register("oak_hoe", new HoeItem(ToolMaterials.WOOD, -1, -2.0F, new FabricItemSettings()));
    public static final Item OAK_AXE = register("oak_axe", new AxeItem(ToolMaterials.WOOD, 7, -3.2F, new FabricItemSettings()));
    public static final Item OAK_SHOVEL = register("oak_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new FabricItemSettings()));
    public static final Item BIRCH_PICKAXE = register("birch_pickaxe", new BirchPickaxe(ToolMaterials.WOOD, 1, -2.8F, new FabricItemSettings()));
    public static final Item BIRCH_SWORD = register("birch_sword", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new FabricItemSettings()));
    public static final Item BIRCH_HOE = register("birch_hoe", new HoeItem(ToolMaterials.WOOD, -1, -2.0F, new FabricItemSettings()));
    public static final Item BIRCH_AXE = register("birch_axe", new AxeItem(ToolMaterials.WOOD, 7, -3.2F, new FabricItemSettings()));
    public static final Item BIRCH_SHOVEL = register("birch_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new FabricItemSettings()));
    public static final Item SPRUCE_PICKAXE = register("spruce_pickaxe", new SprucePickaxe(ToolMaterials.WOOD, 1, -2.8F, new FabricItemSettings()));
    public static final Item SPRUCE_SWORD = register("spruce_sword", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new FabricItemSettings()));
    public static final Item SPRUCE_HOE = register("spruce_hoe", new HoeItem(ToolMaterials.WOOD, -1, -2.0F, new FabricItemSettings()));
    public static final Item SPRUCE_AXE = register("spruce_axe", new AxeItem(ToolMaterials.WOOD, 7, -3.2F, new FabricItemSettings()));
    public static final Item SPRUCE_SHOVEL = register("spruce_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new FabricItemSettings()));
    public static final Item JUNGLE_PICKAXE = register("jungle_pickaxe", new JunglePickaxe(ToolMaterials.WOOD, 1, -2.8F, new FabricItemSettings()));
    public static final Item JUNGLE_SWORD = register("jungle_sword", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new FabricItemSettings()));
    public static final Item JUNGLE_HOE = register("jungle_hoe", new HoeItem(ToolMaterials.WOOD, -1, -2.0F, new FabricItemSettings()));
    public static final Item JUNGLE_AXE = register("jungle_axe", new AxeItem(ToolMaterials.WOOD, 7, -3.2F, new FabricItemSettings()));
    public static final Item JUNGLE_SHOVEL = register("jungle_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new FabricItemSettings()));
    public static final Item ACACIA_PICKAXE = register("acacia_pickaxe", new AcaciaPickaxe(ToolMaterials.WOOD, 1, -2.8F, new FabricItemSettings()));
    public static final Item ACACIA_SWORD = register("acacia_sword", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new FabricItemSettings()));
    public static final Item ACACIA_HOE = register("acacia_hoe", new HoeItem(ToolMaterials.WOOD, -1, -2.0F, new FabricItemSettings()));
    public static final Item ACACIA_AXE = register("acacia_axe", new AxeItem(ToolMaterials.WOOD, 7, -3.2F, new FabricItemSettings()));
    public static final Item ACACIA_SHOVEL = register("acacia_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new FabricItemSettings()));
    public static final Item DARK_OAK_PICKAXE = register("dark_oak_pickaxe", new DarkOakPickaxe(ToolMaterials.WOOD, 1, -2.8F, new FabricItemSettings()));
    public static final Item DARK_OAK_SWORD = register("dark_oak_sword", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new FabricItemSettings()));
    public static final Item DARK_OAK_HOE = register("dark_oak_hoe", new HoeItem(ToolMaterials.WOOD, -1, -2.0F, new FabricItemSettings()));
    public static final Item DARK_OAK_AXE = register("dark_oak_axe", new AxeItem(ToolMaterials.WOOD, 7, -3.2F, new FabricItemSettings()));
    public static final Item DARK_OAK_SHOVEL = register("dark_oak_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new FabricItemSettings()));
    public static final Item MANGROVE_PICKAXE = register("mangrove_pickaxe", new MangrovePickaxe(ToolMaterials.WOOD, 1, -2.8F, new FabricItemSettings()));
    public static final Item MANGROVE_SWORD = register("mangrove_sword", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new FabricItemSettings()));
    public static final Item MANGROVE_HOE = register("mangrove_hoe", new HoeItem(ToolMaterials.WOOD, -1, -2.0F, new FabricItemSettings()));
    public static final Item MANGROVE_AXE = register("mangrove_axe", new AxeItem(ToolMaterials.WOOD, 7, -3.2F, new FabricItemSettings()));
    public static final Item MANGROVE_SHOVEL = register("mangrove_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new FabricItemSettings()));
    public static final Item CHERRY_PICKAXE = register("cherry_pickaxe", new CherryPickaxe(ToolMaterials.WOOD, 1, -2.8F, new FabricItemSettings()));
    public static final Item CHERRY_SWORD = register("cherry_sword", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new FabricItemSettings()));
    public static final Item CHERRY_HOE = register("cherry_hoe", new HoeItem(ToolMaterials.WOOD, -1, -2.0F, new FabricItemSettings()));
    public static final Item CHERRY_AXE = register("cherry_axe", new AxeItem(ToolMaterials.WOOD, 7, -3.2F, new FabricItemSettings()));
    public static final Item CHERRY_SHOVEL = register("cherry_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new FabricItemSettings()));
    public static final Item BAMBOO_PICKAXE = register("bamboo_pickaxe", new BambooPickaxe(ToolMaterials.WOOD, 1, -2.8F, new FabricItemSettings()));
    public static final Item BAMBOO_SWORD = register("bamboo_sword", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new FabricItemSettings()));
    public static final Item BAMBOO_HOE = register("bamboo_hoe", new HoeItem(ToolMaterials.WOOD, -1, -2.0F, new FabricItemSettings()));
    public static final Item BAMBOO_AXE = register("bamboo_axe", new AxeItem(ToolMaterials.WOOD, 7, -3.2F, new FabricItemSettings()));
    public static final Item BAMBOO_SHOVEL = register("bamboo_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new FabricItemSettings()));
    public static final Item CRIMSON_PICKAXE = register("crimson_pickaxe", new CrimsonPickaxe(ToolMaterials.WOOD, 1, -2.8F, new FabricItemSettings()));
    public static final Item CRIMSON_SWORD = register("crimson_sword", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new FabricItemSettings()));
    public static final Item CRIMSON_HOE = register("crimson_hoe", new HoeItem(ToolMaterials.WOOD, -1, -2.0F, new FabricItemSettings()));
    public static final Item CRIMSON_AXE = register("crimson_axe", new AxeItem(ToolMaterials.WOOD, 7, -3.2F, new FabricItemSettings()));
    public static final Item CRIMSON_SHOVEL = register("crimson_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new FabricItemSettings()));
    public static final Item WARPED_PICKAXE = register("warped_pickaxe", new WarpedPickaxe(ToolMaterials.WOOD, 1, -2.8F, new FabricItemSettings()));
    public static final Item WARPED_SWORD = register("warped_sword", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new FabricItemSettings()));
    public static final Item WARPED_HOE = register("warped_hoe", new HoeItem(ToolMaterials.WOOD, -1, -2.0F, new FabricItemSettings()));
    public static final Item WARPED_AXE = register("warped_axe", new AxeItem(ToolMaterials.WOOD, 7, -3.2F, new FabricItemSettings()));
    public static final Item WARPED_SHOVEL = register("warped_shovel", new ShovelItem(ToolMaterials.WOOD, 1.5F, -3.0F, new FabricItemSettings()));
