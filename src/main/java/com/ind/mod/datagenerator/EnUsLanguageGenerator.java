...
public class EnUsLanguageGenerator extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(ModItems.OAK_AXE, "Oak Axe");
        translationBuilder.add(ModItems.OAK_SWORD, "Oak Sword");
        translationBuilder.add(ModItems.OAK_SHOVEL, "Oak Shovel");
        translationBuilder.add(ModItems.OAK_HOE, "Oak Hoe");
        translationBuilder.add(ModItems.BIRCH_PICKAXE, "Birch Pickaxe");
        translationBuilder.add(ModItems.BIRCH_AXE, "Birch Axe");
        translationBuilder.add(ModItems.BIRCH_SWORD, "Birch Sword");
        translationBuilder.add(ModItems.BIRCH_SHOVEL, "Birch Shovel");
        translationBuilder.add(ModItems.BIRCH_HOE, "Birch Hoe");
        translationBuilder.add(ModItems.SPRUCE_PICKAXE, "Spruce Pickaxe");
        translationBuilder.add(ModItems.SPRUCE_AXE, "Spruce Axe");
        translationBuilder.add(ModItems.SPRUCE_SWORD, "Spruce Sword");
        translationBuilder.add(ModItems.SPRUCE_SHOVEL, "Spruce Shovel");
        translationBuilder.add(ModItems.SPRUCE_HOE, "Spruce Hoe");
        translationBuilder.add(ModItems.JUNGLE_PICKAXE, "Jungle Pickaxe");
        translationBuilder.add(ModItems.JUNGLE_AXE, "Jungle Axe");
        translationBuilder.add(ModItems.JUNGLE_SWORD, "Jungle Sword");
        translationBuilder.add(ModItems.JUNGLE_SHOVEL, "Jungle Shovel");
        translationBuilder.add(ModItems.JUNGLE_HOE, "Jungle Hoe");
        translationBuilder.add(ModItems.DARK_OAK_PICKAXE, "Dark Oak Pickaxe");
        translationBuilder.add(ModItems.DARK_OAK_AXE, "Dark Oak Axe");
        translationBuilder.add(ModItems.DARK_OAK_SWORD, "Dark Oak Sword");
        translationBuilder.add(ModItems.DARK_OAK_SHOVEL, "Dark Oak Shovel");
        translationBuilder.add(ModItems.DARK_OAK_HOE, "Dark Oak Hoe");
        translationBuilder.add(ModItems.ACACIA_PICKAXE, "Acacia Pickaxe");
        translationBuilder.add(ModItems.ACACIA_AXE, "Acacia Axe");
        translationBuilder.add(ModItems.ACACIA_SWORD, "Acacia Sword");
        translationBuilder.add(ModItems.ACACIA_SHOVEL, "Acacia Shovel");
        translationBuilder.add(ModItems.ACACIA_HOE, "Acacia Hoe");
        translationBuilder.add(ModItems.MANGROVE_PICKAXE, "Mangrove Pickaxe");
        translationBuilder.add(ModItems.MANGROVE_AXE, "Mangrove Axe");
        translationBuilder.add(ModItems.MANGROVE_SWORD, "Mangrove Sword");
        translationBuilder.add(ModItems.MANGROVE_SHOVEL, "Mangrove Shovel");
        translationBuilder.add(ModItems.MANGROVE_HOE, "Mangrove Hoe");
        translationBuilder.add(ModItems.CHERRY_PICKAXE, "Cherry Pickaxe");
        translationBuilder.add(ModItems.CHERRY_AXE, "Cherry Axe");
        translationBuilder.add(ModItems.CHERRY_SWORD, "Cherry Sword");
        translationBuilder.add(ModItems.CHERRY_SHOVEL, "Cherry Shovel");
        translationBuilder.add(ModItems.CHERRY_HOE, "Cherry Hoe");
        ...
        translationBuilder.add(ModItems.BAMBOO_SHOVEL, "Bamboo Shovel");
        translationBuilder.add(ModItems.BAMBOO_HOE, "Bamboo Hoe");
        translationBuilder.add(ModItems.CRIMSON_PICKAXE, "Crimson Pickaxe");
        translationBuilder.add(ModItems.CRIMSON_AXE, "Crimson Axe");
        translationBuilder.add(ModItems.CRIMSON_SWORD, "Crimson Sword");
        translationBuilder.add(ModItems.CRIMSON_SHOVEL, "Crimson Shovel");
        translationBuilder.add(ModItems.CRIMSON_HOE, "Crimson Hoe");
        translationBuilder.add(ModItems.WARPED_PICKAXE, "Warped Pickaxe");
        translationBuilder.add(ModItems.WARPED_AXE, "Warped Axe");
        translationBuilder.add(ModItems.WARPED_SWORD, "Warped Sword");
