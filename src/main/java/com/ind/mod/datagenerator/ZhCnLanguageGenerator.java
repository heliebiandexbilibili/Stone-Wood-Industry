...
public class ZhCnLanguageGenerator extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(ModItems.END_STONE_PICKAXE, "末地石镐子");
        translationBuilder.add(ModItems.END_STONE_AXE, "末地石斧头");
        translationBuilder.add(ModItems.END_STONE_HOE, "末地石锄头");
        translationBuilder.add(ModItems.END_STONE_SHOVEL, "末地石铲子");
