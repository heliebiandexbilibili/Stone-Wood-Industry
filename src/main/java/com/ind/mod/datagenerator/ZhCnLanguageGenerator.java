...
public class ZhCnLanguageGenerator extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(ModItems.SMOOTH_STONE_AXE, "平滑石斧");
        ...
        translationBuilder.add(ModItems.CRYING_OBSIDIAN_PICKAXE, "哭泣的黑曜石镐");
        translationBuilder.add(ModItems.CRYING_OBSIDIAN_AXE, "哭泣的黑曜石斧");
        translationBuilder.add(ModItems.CRYING_OBSIDIAN_HOE, "哭泣的黑曜石锄");
        translationBuilder.add(ModItems.CRYING_OBSIDIAN_SHOVEL, "哭泣的黑曜石铲");
        ...
        translationBuilder.add(ModItems.OBSIDIAN_SHOVEL, "黑曜石铲");
        translationBuilder.add(ModItems.OBSIDIAN_SWORD, "黑曜石剑");
        translationBuilder.add(ModItems.END_STONE_PICKAXE, "末地石镐");
        translationBuilder.add(ModItems.END_STONE_AXE, "末地石斧");
        translationBuilder.add(ModItems.END_STONE_HOE, "末地石锄");
        translationBuilder.add(ModItems.END_STONE_SHOVEL, "末地石铲");
        translationBuilder.add(ModItems.END_STONE_SWORD, "末地石剑");
        ...
        translationBuilder.add(ModItems.BLACKSTONE_PICKAXE, "黑石镐");
        translationBuilder.add(ModItems.BLACKSTONE_AXE, "黑石斧");
        translationBuilder.add(ModItems.BLACKSTONE_HOE, "黑石锄");
        translationBuilder.add(ModItems.BLACKSTONE_SHOVEL, "黑石铲");
        translationBuilder.add(ModItems.BLACKSTONE_SWORD, "黑石剑");
        translationBuilder.add(ModItems.DEEPSLATE_PICKAXE, "深板岩镐");
        translationBuilder.add(ModItems.DEEPSLATE_AXE, "深板岩斧");
        translationBuilder.add(ModItems.DEEPSLATE_HOE, "深板岩锄");
        translationBuilder.add(ModItems.DEEPSLATE_SHOVEL, "深板岩铲");
        translationBuilder.add(ModItems.DEEPSLATE_SWORD, "深板岩剑");
        translationBuilder.add(ModItems.NETHERRACK_PICKAXE, "下界岩镐");
        translationBuilder.add(ModItems.NETHERRACK_AXE, "下界岩斧");
        translationBuilder.add(ModItems.NETHERRACK_HOE, "下界岩锄");
        translationBuilder.add(ModItems.NETHERRACK_SHOVEL, "下界岩铲");
        translationBuilder.add(ModItems.NETHERRACK_SWORD, "下界岩剑");
        translationBuilder.add(ModItems.DIORITE_PICKAXE, "闪长岩镐");
        translationBuilder.add(ModItems.DIORITE_AXE, "闪长岩斧");
        translationBuilder.add(ModItems.DIORITE_HOE, "闪长岩锄");
        translationBuilder.add(ModItems.DIORITE_SHOVEL, "闪长岩铲");
        translationBuilder.add(ModItems.DIORITE_SWORD, "闪长岩剑");
        translationBuilder.add(ModItems.GRANITE_PICKAXE, "花岗岩镐");
        translationBuilder.add(ModItems.GRANITE_AXE, "花岗岩斧");
        translationBuilder.add(ModItems.GRANITE_HOE, "花岗岩锄");
        translationBuilder.add(ModItems.GRANITE_SHOVEL, "花岗岩铲");
        translationBuilder.add(ModItems.GRANITE_SWORD, "花岗岩剑");
        translationBuilder.add(ModItems.ANDESITE_PICKAXE, "安山岩镐");
        translationBuilder.add(ModItems.ANDESITE_AXE, "安山岩斧");
        translationBuilder.add(ModItems.ANDESITE_HOE, "安山岩锄");
        translationBuilder.add(ModItems.ANDESITE_SHOVEL, "安山岩铲");
        translationBuilder.add(ModItems.ANDESITE_SWORD, "安山岩剑");
        translationBuilder.add(ModItems.BASALT_PICKAXE, "玄武岩镐");
        translationBuilder.add(ModItems.BASALT_AXE, "玄武岩斧");
        translationBuilder.add(ModItems.BASALT_HOE, "玄武岩锄");
        translationBuilder.add(ModItems.BASALT_SHOVEL, "玄武岩铲");
        translationBuilder.add(ModItems.BASALT_SWORD, "玄武岩剑");
        translationBuilder.add(ModEnchantment.UNDYING, "不死");
        translationBuilder.add(ModItems.OAK_PICKAXE, "橡木镐");
        translationBuilder.add(ModItems.OAK_AXE, "橡木斧");
        translationBuilder.add(ModItems.OAK_SWORD, "橡木剑");
        translationBuilder.add(ModItems.OAK_SHOVEL, "橡木铲");
        translationBuilder.add(ModItems.OAK_HOE, "橡木锄");
        translationBuilder.add(ModItems.BIRCH_PICKAXE, "白桦木镐");
        translationBuilder.add(ModItems.BIRCH_AXE, "白桦木斧");
        translationBuilder.add(ModItems.BIRCH_SWORD, "白桦木剑");
        translationBuilder.add(ModItems.BIRCH_SHOVEL, "白桦木铲");
        translationBuilder.add(ModItems.BIRCH_HOE, "白桦木锄");
        translationBuilder.add(ModItems.SPRUCE_PICKAXE, "云杉木镐");
        translationBuilder.add(ModItems.SPRUCE_AXE, "云杉木斧");
        translationBuilder.add(ModItems.SPRUCE_SWORD, "云杉木剑");
        translationBuilder.add(ModItems.SPRUCE_SHOVEL, "云杉木铲");
        translationBuilder.add(ModItems.SPRUCE_HOE, "云杉木锄");
        translationBuilder.add(ModItems.JUNGLE_PICKAXE, "丛林木镐");
        translationBuilder.add(ModItems.JUNGLE_AXE, "丛林木斧");
        translationBuilder.add(ModItems.JUNGLE_SWORD, "丛林木剑");
        translationBuilder.add(ModItems.JUNGLE_SHOVEL, "丛林木铲");
        translationBuilder.add(ModItems.JUNGLE_HOE, "丛林木锄");
        translationBuilder.add(ModItems.DARK_OAK_PICKAXE, "深色橡木木镐");
        translationBuilder.add(ModItems.DARK_OAK_AXE, "深色橡木斧");
        translationBuilder.add(ModItems.DARK_OAK_SWORD, "深色橡木剑");
        translationBuilder.add(ModItems.DARK_OAK_SHOVEL, "深色橡木铲");
        translationBuilder.add(ModItems.DARK_OAK_HOE, "深色橡木锄");
        translationBuilder.add(ModItems.ACACIA_PICKAXE, "金合欢木镐");
        translationBuilder.add(ModItems.ACACIA_AXE, "金合欢木斧");
        translationBuilder.add(ModItems.ACACIA_SWORD, "金合欢木剑");
        translationBuilder.add(ModItems.ACACIA_SHOVEL, "金合欢木铲");
        translationBuilder.add(ModItems.ACACIA_HOE, "金合欢木锄");
        translationBuilder.add(ModItems.MANGROVE_PICKAXE, "红树木镐");
        translationBuilder.add(ModItems.MANGROVE_AXE, "红树木斧");
        translationBuilder.add(ModItems.MANGROVE_SWORD, "红树木剑");
        translationBuilder.add(ModItems.MANGROVE_SHOVEL, "红树木铲");
        translationBuilder.add(ModItems.MANGROVE_HOE, "红树木锄");
        translationBuilder.add(ModItems.CHERRY_PICKAXE, "樱花木镐");
        translationBuilder.add(ModItems.CHERRY_AXE, "樱花木斧");
        translationBuilder.add(ModItems.CHERRY_SWORD, "樱花木剑");
        translationBuilder.add(ModItems.CHERRY_SHOVEL, "樱花木铲");
        translationBuilder.add(ModItems.CHERRY_HOE, "樱花木锄");
        translationBuilder.add(ModItems.BAMBOO_PICKAXE, "竹镐");
        translationBuilder.add(ModItems.BAMBOO_AXE, "竹斧");
        translationBuilder.add(ModItems.BAMBOO_SWORD, "竹剑");
        translationBuilder.add(ModItems.BAMBOO_SHOVEL, "竹铲");
        translationBuilder.add(ModItems.BAMBOO_HOE, "竹锄");
        translationBuilder.add(ModItems.CRIMSON_PICKAXE, "绯红木镐");
        translationBuilder.add(ModItems.CRIMSON_AXE, "绯红木斧");
        translationBuilder.add(ModItems.CRIMSON_SWORD, "绯红木剑");
        translationBuilder.add(ModItems.CRIMSON_SHOVEL, "绯红木铲");
        translationBuilder.add(ModItems.CRIMSON_HOE, "绯红木锄");
        translationBuilder.add(ModItems.WARPED_PICKAXE, "诡异木镐");
        translationBuilder.add(ModItems.WARPED_AXE, "诡异木斧");
        translationBuilder.add(ModItems.WARPED_SWORD, "诡异木剑");
